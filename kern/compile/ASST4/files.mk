...
pcb_list.o: ${S}/thread/pcb_list.c
	${COMPILE.c} ${S}/thread/pcb_list.c
...
sys_write.o: ${S}/userprog/syscalls_asst2/sys_write.c
	${COMPILE.c} ${S}/userprog/syscalls_asst2/sys_write.c
SRCS+=${S}/userprog/syscalls_asst2/sys_write.c
OBJS+=sys_write.o

sys__exit.o: ${S}/userprog/syscalls_asst2/sys__exit.c
	${COMPILE.c} ${S}/userprog/syscalls_asst2/sys__exit.c
SRCS+=${S}/userprog/syscalls_asst2/sys__exit.c
OBJS+=sys__exit.o

sys_getpid.o: ${S}/userprog/syscalls_asst2/sys_getpid.c
	${COMPILE.c} ${S}/userprog/syscalls_asst2/sys_getpid.c
SRCS+=${S}/userprog/syscalls_asst2/sys_getpid.c
OBJS+=sys_getpid.o

sys_fork.o: ${S}/userprog/syscalls_asst2/sys_fork.c
	${COMPILE.c} ${S}/userprog/syscalls_asst2/sys_fork.c
SRCS+=${S}/userprog/syscalls_asst2/sys_fork.c
OBJS+=sys_fork.o

sys_waitpid.o: ${S}/userprog/syscalls_asst2/sys_waitpid.c
	${COMPILE.c} ${S}/userprog/syscalls_asst2/sys_waitpid.c
SRCS+=${S}/userprog/syscalls_asst2/sys_waitpid.c
OBJS+=sys_waitpid.o

sys_read.o: ${S}/userprog/syscalls_asst2/sys_read.c
	${COMPILE.c} ${S}/userprog/syscalls_asst2/sys_read.c
SRCS+=${S}/userprog/syscalls_asst2/sys_read.c
OBJS+=sys_read.o

sys_execv.o: ${S}/userprog/syscalls_asst2/sys_execv.c
	${COMPILE.c} ${S}/userprog/syscalls_asst2/sys_execv.c
SRCS+=${S}/userprog/syscalls_asst2/sys_execv.c
OBJS+=sys_execv.o

sys_sbrk.o: ${S}/userprog/syscalls_asst3/sys_sbrk.c
	${COMPILE.c} ${S}/userprog/syscalls_asst3/sys_sbrk.c
SRCS+=${S}/userprog/syscalls_asst3/sys_sbrk.c
OBJS+=sys_sbrk.o

sys_open.o: ${S}/userprog/syscalls_asst4/sys_open.c
	${COMPILE.c} ${S}/userprog/syscalls_asst4/sys_open.c
SRCS+=${S}/userprog/syscalls_asst4/sys_open.c
OBJS+=sys_open.o

sys_close.o: ${S}/userprog/syscalls_asst4/sys_close.c
...
autoconf.o: ${S}/compile/ASST4/autoconf.c
	${COMPILE.c} ${S}/compile/ASST4/autoconf.c
SRCS+=${S}/compile/ASST4/autoconf.c
OBJS+=autoconf.o
